...
test('create an engineer object', () => {
    const engineer = new Engineer('Santos');
});

test('input a github account for engineer', () => {
    const githubTest = 'santosGit';
    const engineer = new Engineer('Santos', 1234, 'engineer@yahoo.com', githubTest);
...
test('get Engineer role info', () => {
    ...
    const engineer = new Engineer('Santos', 1234, 'engineer@yahoo.com', 'santosGit', testRole);
